...
//************************************************************************************************************
        ...
        */
        ...
        System.out.println("-------------------------------------------------------------------");
        /*
        !!! В данном примере, как и в предыдущем, время параллельного расчета
        (работы параллельного стрима), как минимум в два раза меньше, чем время
        последовательного (однопоточного) стрима. !!!

        Однако, стоит тщательно подходить к выбору параллельных стримов и методикам
        работы с ними, см. ReadMe.txt
        */
